...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "und"}} className="business-card-link">Amazon Business Card</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "und"}} className="shop-points-link">Shop with Points</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "und"}} className="reload-balance-link">Reload Your Balance</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "und"}} className="currency-converter-link">Amazon Currency Converter</p></Link>
     </div>
