...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "undeli"}} className="business-card-link">Amazon Business Card</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "undeli"}} className="shop-points-link">Shop with Points</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "undeli"}} className="reload-balance-link">Reload Your Balance</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "undeli"}} className="currency-converter-link">Amazon Currency Converter</p></Link>
     </div>
