...
const Footer = () => {
  ...
  <Link><p style={{color: "color : #dddddd ;"}} className="career-link">Careers</p></Link>
  <Link><p style={{color: "color : #dddddd ;"}} className="blog-link">Blog</p></Link>
  <Link><p style={{color: "color : #dddddd ;"}} className="about-link">About Amazon</p></Link>
  <Link><p style={{color: "color : #dddddd ;"}} className="investor-link">Investor Relations</p></Link>
  <Link><p style={{color: "color : #dddddd ;"}} className="devices-link">Amazon Devices</p></Link>
  <Link><p style={{color: "color : #dddddd ;"}} className="science-link">Amazon Science</p></Link>
         </div>
