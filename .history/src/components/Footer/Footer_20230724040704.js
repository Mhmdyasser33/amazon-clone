...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="career-link">Careers</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="blog-link">Blog</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="about-link">About Amazon</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="investor-link">Investor Relations</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="devices-link">Amazon Devices</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" ,fon}} className="science-link">Amazon Science</p></Link>
         </div>
