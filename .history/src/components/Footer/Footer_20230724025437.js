...
const Footer = () => {
  ...
  <Link><p style={{color: "#dddddd", tex}} className="covid-help-link">Amazon and COVID-19</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="account-link">Your Account</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="orders-link">Your Orders</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="shipping-rates-link">Shipping Rates & Policies</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="returns-link">Returns & Replacements</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="content-devices-link">Manage Your Content and Devices</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="assistant-link">Amazon Assistant</p></Link>
  <Link><p style={{color: "#dddddd", tex}} className="help-link">Help</p></Link>
        </div>
       </div>
        </div>
    </>
