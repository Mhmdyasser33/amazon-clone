...
const Footer = () => {
  ...
  <Link><p style={{color: "#dddddd", li}} className="covid-help-link">Amazon and COVID-19</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="account-link">Your Account</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="orders-link">Your Orders</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="shipping-rates-link">Shipping Rates & Policies</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="returns-link">Returns & Replacements</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="content-devices-link">Manage Your Content and Devices</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="assistant-link">Amazon Assistant</p></Link>
  <Link><p style={{color: "#dddddd", li}} className="help-link">Help</p></Link>
        </div>
       </div>
        </div>
