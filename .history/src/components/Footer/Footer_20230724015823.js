...
const Footer = () => {
  ...
  <Link><p style={} className="covid-help-link">Amazon and COVID-19</p></Link>
  <Link><p style={} className="account-link">Your Account</p></Link>
  <Link><p style={} className="orders-link">Your Orders</p></Link>
  <Link><p style={} className="shipping-rates-link">Shipping Rates & Policies</p></Link>
  <Link><p style={} className="returns-link">Returns & Replacements</p></Link>
  <Link><p style={} className="content-devices-link">Manage Your Content and Devices</p></Link>
  <Link><p style={} className="assistant-link">Amazon Assistant</p></Link>
  <Link><p style={} className="help-link">Help</p></Link>
        </div>
       </div>
        </div>
