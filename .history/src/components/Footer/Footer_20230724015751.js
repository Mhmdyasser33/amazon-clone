...
const Footer = () => {
  ...
  <Link><p sty className="sell-products-link">Sell products on Amazon</p></Link>
  <Link><p sty className="sell-amazon-business-link">Sell on Amazon Business</p></Link>
  <Link><p sty className="sell-apps-link">Sell apps on Amazon</p></Link>
  <Link><p sty className="affiliate-link">Become an Affiliate</p></Link>
  <Link><p sty className="advertise-link">Advertise Your Products</p></Link>
  <Link><p sty className="self-publish-link">Self-Publish with Us</p></Link>
  <Link><p sty className="amazon-hub-link">Host an Amazon Hub</p></Link>
  <Link><p sty className="more-make-money-link">See More Make Money with Us</p></Link>
       </div>
