...
const Footer = () => {
  ...
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="covid-help-link">Amazon and COVID-19</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="account-link">Your Account</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="orders-link">Your Orders</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="shipping-rates-link">Shipping Rates & Policies</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="returns-link">Returns & Replacements</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="content-devices-link">Manage Your Content and Devices</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="assistant-link">Amazon Assistant</p></Link>
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fon}} className="help-link">Help</p></Link>
        </div>
       </div>
         <hr></hr>
