...
const Footer = () => {
  ...
  <Link><p style={{}} className="sell-products-link">Sell products on Amazon</p></Link>
  <Link><p style={{}} className="sell-amazon-business-link">Sell on Amazon Business</p></Link>
  <Link><p style={{}} className="sell-apps-link">Sell apps on Amazon</p></Link>
  <Link><p style={{}} className="affiliate-link">Become an Affiliate</p></Link>
  <Link><p style={{}} className="advertise-link">Advertise Your Products</p></Link>
  <Link><p style={{}} className="self-publish-link">Self-Publish with Us</p></Link>
  <Link><p style={{}} className="amazon-hub-link">Host an Amazon Hub</p></Link>
  <Link><p style={{}} className="more-make-money-link">See More Make Money with Us</p></Link>
       </div>
