...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , tex}} className="business-card-link">Amazon Business Card</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , tex}} className="shop-points-link">Shop with Points</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , tex}} className="reload-balance-link">Reload Your Balance</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , tex}} className="currency-converter-link">Amazon Currency Converter</p></Link>
     </div>
