...
const Footer = () => {
  ...
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="covid-help-link">Amazon and COVID-19</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="account-link">Your Account</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="orders-link">Your Orders</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="shipping-rates-link">Shipping Rates & Policies</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="returns-link">Returns & Replacements</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="content-devices-link">Manage Your Content and Devices</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="assistant-link">Amazon Assistant</p></Link>
  <Link><p style={{color: "#dddddd", lineHeight : "16."}} className="help-link">Help</p></Link>
        </div>
       </div>
        </div>
