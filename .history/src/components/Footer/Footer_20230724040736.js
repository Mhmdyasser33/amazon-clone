...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fonsi}} className="business-card-link">Amazon Business Card</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fonsi}} className="shop-points-link">Shop with Points</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fonsi}} className="reload-balance-link">Reload Your Balance</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fonsi}} className="currency-converter-link">Amazon Currency Converter</p></Link>
     </div>
