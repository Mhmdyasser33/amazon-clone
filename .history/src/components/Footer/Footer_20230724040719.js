...
const Footer = () => {
  ...
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="sell-products-link">Sell products on Amazon</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="sell-amazon-business-link">Sell on Amazon Business</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="sell-apps-link">Sell apps on Amazon</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="affiliate-link">Become an Affiliate</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="advertise-link">Advertise Your Products</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="self-publish-link">Self-Publish with Us</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="amazon-hub-link">Host an Amazon Hub</p></Link>
  <Link to="#"><p style={{color: "#dddddd" , textDecoration : "underline" , fon}} className="more-make-money-link">See More Make Money with Us</p></Link>
       </div>
