...
import trueAndFalseIcon from '../../images/icons/Screenshot (131).png'
const Footer = () => {
  const handleClick = (e) =>{
    e.preventDefault() ;
  ...
  return (
    ...
    <div className='footer'>
        <div className='footer-container' onClick={handleClick}>
      <Link>
 ...
 <Link>
 <p className='conditions-of-use'>Conditions of Use</p>
 </Link>
 <Link>
 <p className='privacy-notice'>Privacy Notice</p>
 </Link>
<Link>
<p className='ads-privacy-choices'>Your Ads Privacy Choices</p>
</Link>
<img src={trueAndFalseIcon} alt='true-and-false-icon'/>
</div>
<div className='copyright-details'>
 <Link>
 <p className='copyright-info'>© 1996-2023, Amazon.com, Inc. or its affiliates</p>
 </Link>
