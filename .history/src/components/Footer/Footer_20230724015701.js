...
const Footer = () => {
  ...
  <Link><p s className="career-link">Careers</p></Link>
  <Link><p s className="blog-link">Blog</p></Link>
  <Link><p s className="about-link">About Amazon</p></Link>
  <Link><p s className="investor-link">Investor Relations</p></Link>
  <Link><p s className="devices-link">Amazon Devices</p></Link>
  <Link><p s className="science-link">Amazon Science</p></Link>
         </div>
