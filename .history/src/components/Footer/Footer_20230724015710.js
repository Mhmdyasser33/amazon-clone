...
const Footer = () => {
  ...
  <Link><p style={{color: ""}} className="career-link">Careers</p></Link>
  <Link><p style={{color: ""}} className="blog-link">Blog</p></Link>
  <Link><p style={{color: ""}} className="about-link">About Amazon</p></Link>
  <Link><p style={{color: ""}} className="investor-link">Investor Relations</p></Link>
  <Link><p style={{color: ""}} className="devices-link">Amazon Devices</p></Link>
  <Link><p style={{color: ""}} className="science-link">Amazon Science</p></Link>
         </div>
