...
const Footer = () => {
  ...
  <Link><p style={{color: "#dddddd", textDecoration : "underline" , fontSize : "14px"}} className="help-link">Help</p></Link>
       ...
       <div className='footer-links-container'>
        <Link>
          <h5 style={{color : "#dddddd"}}>Amazon Music</h5 style={{color : "#dddddd"}}>
          <h6>Stream millions of songs</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Amazon Advertising</h5 style={{color : "#dddddd"}}>
          <h6>Find, attract, and engage customers</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>6pm</h5 style={{color : "#dddddd"}}>
          <h6>Score deals on fashion brands</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>AbeBooks</h5 style={{color : "#dddddd"}}>
          <h6>Books, art & collectibles</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>ACX</h5 style={{color : "#dddddd"}}>
          <h6>AudioBook Publishing Made Easy</h6>
        </Link>

        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Sell on Amazon</h5 style={{color : "#dddddd"}}>
          <h6>Start a Selling Account</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Amazon Business</h5 style={{color : "#dddddd"}}>
          <h6>Everything For Your Business</h6>
        </Link>
        <br></br>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>AmazonGlobal </h5 style={{color : "#dddddd"}}>
          <h6>Ship Orders Internationally</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Home Services	</h5 style={{color : "#dddddd"}}>
          <h6>Experienced Pros Happiness Guarantee</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Amazon Ignite</h5 style={{color : "#dddddd"}}>
          <h6>Sell your original Digital Educational Resources</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Amazon Web Services</h5 style={{color : "#dddddd"}}>
          <h6>Scalable Cloud Computing Services</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Audible</h5 style={{color : "#dddddd"}}>
          <h6>Listen to Books & Original Audio Performances</h6>
        </Link>

        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Book Depository</h5 style={{color : "#dddddd"}}>
          <h6>Books With Free Delivery Worldwide</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Box Office Mojo</h5 style={{color : "#dddddd"}}>
          <h6>Find Movie Box Office Data</h6>
        </Link>
        <br></br>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>ComiXology</h5 style={{color : "#dddddd"}}>
          <h6>Thousands of Digital Comics</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	DPReview</h5 style={{color : "#dddddd"}}>
          <h6>Digital Photography</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Fabric</h5 style={{color : "#dddddd"}}>
          <h6>Sewing, Quilting & Knitting</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Goodreads</h5 style={{color : "#dddddd"}}>
          <h6>Book reviews & recommendations</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>IMDb</h5 style={{color : "#dddddd"}}>
          <h6>Movies, TV & Celebrities</h6>
        </Link>

        <Link className=''>
          <h5 style={{color : "#dddddd"}}>IMDbPro</h5 style={{color : "#dddddd"}}>
          <h6>Get Info Entertainment Professionals Need</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Kindle Direct </h5 style={{color : "#dddddd"}}>
          <h6>Publishing Indie Digital & Print Publishing Made Easy</h6>
        </Link>
        <br></br>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Prime Video</h5 style={{color : "#dddddd"}}>
          <h6>Direct Video Distribution Made Easy  </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Shopbop</h5 style={{color : "#dddddd"}}>
          <h6>Designer Fashion Brands  </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Woot!</h5 style={{color : "#dddddd"}}>
          <h6>Deals and Shenanigans  </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>Zappos</h5 style={{color : "#dddddd"}}>
          <h6> Shoes & Clothing</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Ring</h5 style={{color : "#dddddd"}}>
          <h6>Smart Home Security Systems </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	eero WiFi</h5 style={{color : "#dddddd"}}>
          <h6>Stream 4K Video in Every Room  </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Blink</h5 style={{color : "#dddddd"}}>
          <h6>Smart Security for Every Home</h6>
        </Link>
    <br></br>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Neighbors App</h5 style={{color : "#dddddd"}}>
          <h6>Real-Time Crim & Safety Alerts</h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>	Amazon Subscription </h5 style={{color : "#dddddd"}}>
          <h6>Boxes Top subscription boxes – right to your door  </h6>
        </Link>
        <Link className=''>
          <h5 style={{color : "#dddddd"}}>PillPack</h5 style={{color : "#dddddd"}}>
