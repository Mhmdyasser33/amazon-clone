...
const Home = () => {
  return (
    ...
    rating={5}/>
     ...
     image={imageFive}
     price={250}
     title="MeLE PCG02 Fanless Mini PC Stick Windows 11 Pro J4125 8GB/128GB Portable Mini Desktop Computer Stick Business & Home Video Support HDMI 4K 60Hz, BT4.2, 2.4G/5.8G Dual Band Wi-Fi."
     rating={5}/>
     </div>
     <div className='home-row'>
     <Product
