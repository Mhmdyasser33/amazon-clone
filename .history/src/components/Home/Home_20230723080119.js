...
const Home = () => {
  return (
    ...
    rating={5}/>
     ...
     <Product
     image={imageNine}
     title="smart watch for Men and woman"/>
     <Product
     image={imageSeven}
     ...
     <Product
    image={imageSix}
    title = " title="SAMSUNG Galaxy S22 Ultra Cell Phone, Factory Unlocked Android Smartphone, 128GB, 8K Camera & Video, Brightest Display Screen, S Pen, Long Battery Life, Fast 4nm Processor, US Version, Phantom Black""/>
     </div>
      </dvi>
    </div>
  )
