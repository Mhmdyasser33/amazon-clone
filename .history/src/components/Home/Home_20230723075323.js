...
const Home = () => {
  return (
    ...
    rating={5}/>
     ...
     <Product
     image={imageNine}
     title="Smart Watch for Men(Answer/Make Call),Alexa Built-in,1.8"Fitness Tracker with Heart Rate Sleep SpO2 Monitor,100+Sport Mode,5ATM Waterproof,Activity Trackers and Smartwatches for iOS and Android"/>
     <Product
     image={imageSeven}/>
     <Product
      image={imageEight}
