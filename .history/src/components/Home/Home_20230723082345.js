...
const Home = () => {
  return (
    <div className='homr'>
     ...
     <img src={HomeImg} alt='home-img' style="wi"/>
    ...
    rating={5}/>
     ...
     image={imageFive}
     price={250}
     title="MeLE PCG02 Fanless Mini PC Stick Windows 11 Pro J4125 8GB/128GB Portable Mini Desktop Computer Stick Business.."
     rating={5}/>
     </div>
     <div className='home-row'>
     <Product
