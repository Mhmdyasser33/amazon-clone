...
const Home = () => {
  return (
    ...
    rating={5}/>
     ...
     <Product
     image={imageNine}
    title="Smart Watch Fitness Tracker with Heart Rate Blood Oxygen Blood Pressure Sleep Monitor 100 Sports Modes Step Calorie Counte...
    Smart Watch Fitness Tracker with Heart Rate Blood Oxygen Blood Pressure Sleep Monitor 100 Sports Modes Step Calorie Counter Activity Health Trackers IP68 Waterproof for Android Phones iPhone Women"
     price={140}
     rating={5}/>
     <Product
     image={imageSeven}
